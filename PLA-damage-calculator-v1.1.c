...
float getAttack(float Attack) {
    ...
    scanf("%f", &Attack);
    int WildMightOffenseCheck;
    printf("\nEnter 1 if the attacker is affected by Wild/Terrible Might, 0 otherwise: ");
    scanf("%d", &WildMightOffenseCheck);
    switch(WildMightOffenseCheck) {
        case 1:
        Attack = Attack * 1.5;
        break;
        case 0:
    ...
    int SlowStartCheck;
    printf("\nEnter 1 if the attacker is under the effect of Slow Start, 0 otherwise: ");
    scanf("%d", &SlowStartCheck);
    switch(SlowStartCheck) {
        case 1:
        Attack = Attack * 0.5;
        break;
        case 0:
...
float getDefense(float Defense) {
    ...
    scanf("%f", &Defense);
    int WildMightDefenseCheck;
    printf("\nEnter 1 if the defender is affected by Wild/Terrible Might, 0 otherwise: ");
    scanf("%d", &WildMightDefenseCheck);
    switch(WildMightDefenseCheck) {
        case 1:
        Defense = Defense * 1.5;
        break;
        case 0:
...
int main(void) {
    ...
    printf("\n\nDamage calculator for Legends Arceus, version 1.1");
